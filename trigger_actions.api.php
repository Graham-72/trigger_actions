 ...
 * trigger_actions_do() to fire off the actions.
 *
 * @return
 ...
 *
 * @see hook_trigger_actions_info()
 * @see hook_trigger_actions_info_alter()
 */
function hook_trigger_actions_info() {
  return array(
    'node' => array(
      'node_presave' => array(
...
/**
 * Alter triggers declared by hook_trigger_actions_info().
 *
 * @param $triggers
 *   Array of trigger information returned by hook_trigger_actions_info()
 *   implementations. Modify this array in place. See hook_trigger_actions_info()
 *   for information on what this might contain.
 */
function hook_trigger_actions_info_alter(&$triggers) {
